...
The crisp and probabilistic ELECTRE Tri-B method is implemented the module [electre_tri.py](./src/electre_tri.py).  Four workflows are presented in [workflows.ipynb](./docs/how_to_guides/workflows.ipynb) for crisp and probabilistic ELECTRE Tri-B methods using explicitly defined base profiles or their worst and best levels.
